...
// Ambil produk Groceries dari database
...
<main>
    <div class="icon-category">
        <img src="/PWDTUBES_WalBayExpress/assets/img/category/groceries.jpg" alt="Groceries">
    </div>
    <h1>Groceries Products</h1>
    <p>Temukan berbagai produk kebutuhan sehari-hari untuk keluarga Anda!</p>
