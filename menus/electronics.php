...
// Ambil produk Electronics dari database
...
<main>
    <div class="icon-category">
        <img src="/PWDTUBES_WalBayExpress/assets/img/category/electronics.png" alt="Electronics">
    </div>
    <h1>Electronics Products</h1>
    <p>Discover the latest electronics with quality and warranty!</p>
