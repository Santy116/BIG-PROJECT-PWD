...
// Ambil produk Home & Garden dari database
$query = "SELECT p.*, c.name AS category_name 
          FROM products p 
          JOIN categories c ON p.category_id = c.id 
          WHERE c.name = 'home & garden' 
...
<main>
    <div class="icon-category">
        <img src="/PWDTUBES_WalBayExpress/assets/img/category/home-garden.jpg" alt="Home & Garden">
    </div>
    <h1>Home & Garden Products</h1>
    <p>Discover a variety of products for your home and garden!</p>
