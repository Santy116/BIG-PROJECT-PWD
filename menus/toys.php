...
// Ambil produk Toys dari database
...
<main>
    <div class="icon-category">
        <img src="/PWDTUBES_WalBayExpress/assets/img/category/toys.jpg" alt="Toys">
    </div>
    <h1>Toys Products</h1>
    <p>Discover a variety of toys for kids and adults alike!</p>
