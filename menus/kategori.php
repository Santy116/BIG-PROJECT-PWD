...
// Ambil kategori yang dipilih dari URL, default ke kategori pertama jika tidak ada
$selected_category = isset($_GET['category']) ? $_GET['category'] : ($categories[0]['id'] ?? null);
...
<div class="container">
    <h1>Shop by Category: <?= htmlspecialchars(ucfirst($category_name)) ?></h1>
    <div class="category-nav">
        <?php foreach ($categories as $cat): ?>
            <a href="kategori.php?category=<?= $cat['id'] ?>" 
               class="category-link <?= ($selected_category == $cat['id']) ? 'active' : '' ?>">
